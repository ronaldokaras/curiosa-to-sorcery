...
5. Baixe o arquivo `ligaSorcery.csv` gerado
...
|------------|---------------------------------------------------------------------------|--------------------------------------|
| **Simples**   | Converte apenas as informações do seu CSV                                | Uso diário / rápido                  |
| **Completo**  | Cruza os dados com as bases oficiais dos sets (raridade, cor, etc.)     | Quando precisar de dados mais ricos  |
